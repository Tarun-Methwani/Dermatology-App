...
public class ForgetPasswordActivityP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_forget_password_p);
            ...
            public void onClick(View v) {
                ...
                uAuth.sendPasswordResetEmail(etEmailForget.getText().toString().trim()).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        {
                            Toast.makeText(ForgetPasswordActivityP.this, "Reset Link Has Been send to your email address", Toast.LENGTH_SHORT).show();
                        ...
                        {
                            Toast.makeText(ForgetPasswordActivityP.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
